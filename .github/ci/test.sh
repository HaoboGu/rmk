...
prebuild_args=(
    ...
    --- build --manifest-path rmk-types/Cargo.toml --tests --features rmk_protocol
...
cargo +stable test --manifest-path rmk-types/Cargo.toml --features rmk_protocol --verbose
