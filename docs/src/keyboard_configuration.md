...
serial = [
    ...
    # For the RP2040 only, you can also use RMK's Programmable IO (PIO) serial port, using either or both of the RP2040's two PIO blocks, PIO0 and PIO1, in half-duplex mode using the same pin for RX/TX
