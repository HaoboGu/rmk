...
The following guide is for local compilation. If you are using [cloud compilation](/docs/user_guide/create_firmware/cloud_compilation), you can skip the following steps and just rerun the github action.
