...
RMK v0.7 brings many exciting features, making configuration easier and more flexible. Check out the [CHANGELOG](https://github.com/rmk-rs/rmk/blob/main/rmk/CHANGELOG.md) for more details.
