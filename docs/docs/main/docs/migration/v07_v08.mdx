...
Dongle support is back! Checkout [config example](https://github.com/rmk-rs/rmk/tree/main/examples/use_config/nrf52840_ble_split_dongle) and [Rust example](https://github.com/rmk-rs/rmk/tree/main/examples/use_rust/nrf52840_ble_split_dongle) for more details.
