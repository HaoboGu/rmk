...
RMK provides many examples for various microcontrollers using both configuration methods. See the [examples folder](https://github.com/rmk-rs/rmk/tree/main/examples) in the RMK repository.
...
`keyboard.toml` is the default configuration method when your keyboard project is generated by [rmkit](https://github.com/rmk-rs/rmkit).
...
Check out [examples](https://github.com/rmk-rs/rmk/tree/main/examples/use_rust) that use Rust API if you want to try the fantastic Rust programming language. [Configuration](../configuration) documentation also includes Rust API usage.
