...
(see also the examples `memory.x` in `examples/use_rust/rp2040_embassy_boot/` for RP2040 or `examples/use_rust/nrf52840_embassy_boot/` for nRF)
...
- `rmk-boot-rp2040-4mb.uf2` – for 4 MB flash
- `rmk-boot-rp2040-8mb.uf2` – for 8 MB flash
- `rmk-boot-rp2040-16mb.uf2` – for 16 MB flash
...
- The flash partitioning in `memory.x` matches your bootloader and flash size (see `examples/use_rust/rp2040_embassy_boot/` for RP2040 or `examples/use_rust/nrf52840_embassy_boot/` for nRF)
