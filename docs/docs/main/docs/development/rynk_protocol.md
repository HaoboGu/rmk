...
| `0x0901` | `GetDongleSlots`      | `()`                   | `DongleSlots`           | `dongle` | Snapshot of the dongle's slot table. Doubles as the dongle probe, since a keyboard answers the whole segment with `UnknownCmd`. |
| `0x0902` | `SelectDongleTarget`  | `u8`                   | `()`                    | `dongle` | Route subsequent forwarded commands to this slot.                                                                               |
| `0x0903` | `ForgetDongleSlot`    | `u8`                   | `()`                    | `dongle` | Delete a slot's bond.                                                                                                           |
...
| `0x8901` | `DongleSlotsChange`   | `DongleSlots`      | `dongle` | Pushed when a slot's bond or connection state changes. |
