...
- **On-the-fly Keymap Customization**: Change your keymap in real time via Vial (enabled by default) or RMK's native Rynk protocol.
...
<div className="grid grid-cols-1 md:grid-cols-2 gap-5">
  ...
  />
  <LinkCard
    href="https://github.com/rmk-rs/rmk/tree/main/examples"
    title="Examples"
