...
pub struct StickyKeyConfig {
    ...
    pub release_on_keyup_after_ms: Option<u64>,
            ...
            .map(|sticky| -> Result<StickyKeyConfig, String> {
                let parse_profile = |profile: crate::StickyKeyProfile| -> Result<StickyKeyProfile, String> {
                    Ok(StickyKeyProfile {
                        ...
                        release_on_keyup_after_ms: profile.release_on_keyup_after.map(|duration| duration.0),
                ...
                Ok(StickyKeyConfig {
                    ...
                    release_on_keyup_after_ms: sticky.release_on_keyup_after.map(|duration| duration.0),
...
"#,
        ...
        assert_eq!(sticky.release_on_keyup_after_ms, Some(300));
        assert_eq!(
        ...
        assert_eq!(alt_tab.release_on_keyup_after_ms, Some(500));
        assert_eq!(
