...
use super::config::{ControllerConfig, InputProcessorConfig};
use super::parser::{parse_controller_config, parse_input_processor_config};
...
pub fn input_processor_impl(
    ...
    let config = match parse_input_processor_config(attr) {
        Ok(config) => config,
