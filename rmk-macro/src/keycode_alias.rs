...
pub(crate) static KEYCODE_ALIAS: Lazy<HashMap<&str, &str>> = Lazy::new(|| {
    ...
    add_alias!("Language1" = "language_1", "lng_1");
    add_alias!("Language2" = "language_2", "lng_2");
    add_alias!("Language3" = "language_3", "lng_3");
    add_alias!("Language4" = "language_4", "lng_4");
    add_alias!("Language5" = "language_5", "lng_5");
    add_alias!("Language6" = "language_6", "lng_6");
    add_alias!("Language7" = "language_7", "lng_7");
    add_alias!("Language8" = "language_8", "lng_8");
    add_alias!("Language9" = "language_9", "lng_9");
