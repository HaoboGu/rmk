...
pub struct HidLeds {
    ...
    //Compose, Kana, Power, Shift, DoNotDisturb, Mute
    #[bits(1)]
    _reserved1: bool,
    #[bits(1)]
    _reserved2: bool,
...
impl BitAndAssign for HidLeds {
    fn bitand_assign(&mut self, rhs: Self) {
        *self = *self & rhs;
    }
}
impl BitOrAssign for HidLeds {
    fn bitor_assign(&mut self, rhs: Self) {
        *self = *self | rhs;
    }
}
