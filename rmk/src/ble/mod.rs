...
>(
    ...
    build_ble_stack_with_peripheral_flag(
        controller,
        host_address,
        random_generator,
        resources,
...
/// Build a BLE stack with split-peripheral-specific security capabilities.
pub async fn build_ble_stack_with_peripheral_flag<
    'a,
    C: Controller + ControllerCmdAsync<LeSetPhy>,
    P: PacketPool,
    RNG: RngCore + CryptoRng,
>(
    ...
    #[cfg(feature = "passkey_entry")]
    if crate::PASSKEY_ENTRY_ENABLED && !is_split_peripheral {
...
>(
    ...
    #[cfg(feature = "passkey_entry")]
    let _passkey_cleanup = crate::ble::passkey::PasskeyCleanupGuard::new();
