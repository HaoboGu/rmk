...
use crate::hid_state::{HidLeds, HidModifiers, HidMouseButtons};
...
impl StateBits {
    pub const fn new_from(modifiers: HidModifiers, leds: HidLeds, mouse: HidMouseButtons) -> Self {
        StateBits {
            modifiers: modifiers,
            leds: leds,
            mouse: mouse,
