...
impl<'a> RynkService<'a> {
    pub(crate) async fn handle_get_behavior_config(&self, msg: &mut RynkMessage<'_>) -> Result<usize, RynkError> {
    ...
    pub(crate) async fn handle_set_behavior_config(&self, msg: &mut RynkMessage<'_>) -> Result<usize, RynkError> {
