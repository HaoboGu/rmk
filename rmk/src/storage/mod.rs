    ...
    fn serialize_into(&self, buffer: &mut [u8]) -> Result<usize, SerializationError> {
        ...
        match self {
            ...
            StorageData::BehaviorConfig(c) => {
                ...
                BigEndian::write_u32(&mut buffer[3..7], c.morse_default_profile.into());

                BigEndian::write_u16(&mut buffer[7..9], c.combo_timeout);
                BigEndian::write_u16(&mut buffer[9..11], c.one_shot_timeout);
                BigEndian::write_u16(&mut buffer[11..13], c.tap_interval);
                BigEndian::write_u16(&mut buffer[13..15], c.tap_capslock_interval);
                Ok(15)
            }
            #[cfg(feature = "host")]
            ...
            match key_type {
                ...
                StorageKeys::BehaviorConfig => {
                    ...
                    let keymap_config = BehaviorConfig {
                        ...
                        morse_default_profile: MorseProfile::from(BigEndian::read_u32(&buffer[3..7])),

                        combo_timeout: BigEndian::read_u16(&buffer[7..9]),
                        one_shot_timeout: BigEndian::read_u16(&buffer[9..11]),
                        tap_interval: BigEndian::read_u16(&buffer[11..13]),
                        tap_capslock_interval: BigEndian::read_u16(&buffer[13..15]),
                    };
