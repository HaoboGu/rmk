...
RMK supports [nice!nano](https://nicekeyboards.com/nice-nano) as well as any custom nrf54l15 board you have. 
...
MEMORY
{
  ...
  /* These values correspond to the nrf54l15 WITH Adafruit nRF52 bootloader */
...
{
  /* NOTE 1 K = 1 KiB = 1024 bytes */
  /* These values correspond to the nrf54l15 */
