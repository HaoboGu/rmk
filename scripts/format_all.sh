...
# The rynk host tooling is its own workspace; --all formats every member crate.
log_section "Formatting rynk host workspace"
cargo +nightly fmt --all --manifest-path rynk/Cargo.toml
