...
cd examples/use_config/esp32c3_ble && cargo clean && cd ../../..
cd examples/use_config/esp32c6_ble && cargo clean && cd ../../..
cd examples/use_config/esp32s3_ble && cargo clean && cd ../../..
cd examples/use_rust/esp32c3_ble && cargo clean && cd ../../..
cd examples/use_rust/esp32c6_ble && cargo clean && cd ../../..
cd examples/use_rust/esp32s3_ble && cargo clean && cd ../../..